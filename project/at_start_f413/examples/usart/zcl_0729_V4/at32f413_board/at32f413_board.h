...
#define  APEX_RELEY_CLOCK  CRM_GPIOB_PERIPH_CLOCK
#define  APEX_RELEY_PORT   GPIOB
#define  APEX_RELEY_IO     GPIO_PINS_9
...
#define LCD_RST_CLOCK  CRM_GPIOC_PERIPH_CLOCK
#define LCD_RST_PORT   GPIOC
#define LCD_RST_IO     GPIO_PINS_14

#define LCD_DC_CLOCK  CRM_GPIOC_PERIPH_CLOCK
#define LCD_DC_PORT   GPIOC
#define LCD_DC_IO     GPIO_PINS_13

#define LCD_CS_CLOCK  CRM_GPIOC_PERIPH_CLOCK
#define LCD_CS_PORT   GPIOC
#define LCD_CS_IO     GPIO_PINS_15
...
#define LEDB_CLOCK  CRM_GPIOA_PERIPH_CLOCK
#define LEDB_PORT   GPIOA
#define LEDB_IO      GPIO_PINS_8

#define LEDG_CLOCK  CRM_GPIOB_PERIPH_CLOCK
#define LEDG_PORT   GPIOB
#define LEDG_IO      GPIO_PINS_15

#define SYS_ON_CLOCK  CRM_GPIOB_PERIPH_CLOCK
#define SYS_ON_PORT   GPIOB
#define SYS_ON_IO     GPIO_PINS_4

#define PWR_SW_CLOCK  CRM_GPIOB_PERIPH_CLOCK
#define PWR_SW_PORT   GPIOB
#define PWR_SW_IO     GPIO_PINS_1

#define KEY_S_CLOCK  CRM_GPIOB_PERIPH_CLOCK
#define KEY_S_PORT   GPIOB
#define KEY_S_IO     GPIO_PINS_10

#define KEY_A_CLOCK  CRM_GPIOA_PERIPH_CLOCK
#define KEY_A_PORT   GPIOA
#define KEY_A_IO     GPIO_PINS_15
...
#define BEEP_CLOCK  CRM_GPIOB_PERIPH_CLOCK
#define BEEP_PORT   GPIOB
#define BEEP_IO     GPIO_PINS_8



#define VBUS_CLOCK  CRM_GPIOF_PERIPH_CLOCK
#define VBUS_PORT   GPIOF
#define VBUS_IO     GPIO_PINS_7
